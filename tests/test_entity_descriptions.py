...
DESCRIPTION_LISTS = [
    ...
    (number.HEATPUMP_NUMBER_TYPES, HEAT_PUMP_COMPONENT),
    (number.BIOMASS_BOILER_NUMBER_TYPES, BIOMASS_BOILER_COMPONENT),
    (number.PHOTOVOLTAIC_NUMBER_TYPES, PHOTOVOLTAIC_COMPONENT),
